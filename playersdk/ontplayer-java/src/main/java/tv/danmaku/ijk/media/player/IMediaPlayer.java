...
public interface IMediaPlayer {
    ...
    int MEDIA_BUFFERING_UPDATE = 3;
    int MEDIA_SEEK_COMPLETE = 4;
    int MEDIA_SET_VIDEO_SIZE = 5;
    int MEDIA_TIMED_TEXT = 99;
    int MEDIA_ERROR = 100;
    int MEDIA_INFO = 200;
    ...
    int MEDIA_INFO_CLOSE_INPUT             = 10010;
    ...
    /*customer defined, maybe is different from rtmppkt.h*/
    interface DispatcherPacketType {

        short DISPATCHER_PT_BYTES_READ = 1;
        short DISPATCHER_PT_SOUND = 2;
        short DISPATCHER_PT_PLAY_CYCLE = 3;
        short DISPATCHER_PT_SEEK = 4;
        short DISPATCHER_PT_PAUSE = 5;
    }
    ...
    interface OnScreenshotCompleteListener {
        void onScreenshotComplete(IMediaPlayer mp, int ret, String path);
    }
