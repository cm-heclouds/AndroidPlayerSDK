...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public void setWriteDuplexFlag(int writeDuplexFlag) {
        this.mWriteDuplexFlag = writeDuplexFlag;
    }
    ...
    public int writeDuplex(short pktType, byte[] buf, int size, long ts) {
        return _writeDuplex(mNativeMediaPlayer, pktType, buf, size, ts);
    }

    private native int _writeDuplex(long nativeMediaPlayer, short pktType, byte[] buf, int size, long ts);
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_SCREENSHOT_COMPLETE:
                String path = "";
                if (msg.obj != null) {

                    path = (String)msg.obj;
                }
                player.notifyOnScreenshotComplete(msg.arg1, path);
                return;
            ...
            case MEDIA_INFO:
                switch (msg.arg1) {
                    case MEDIA_INFO_VIDEO_RENDERING_START:
                        ...
                        break;
                    case MEDIA_INFO_START_WRITE_THREAD:
