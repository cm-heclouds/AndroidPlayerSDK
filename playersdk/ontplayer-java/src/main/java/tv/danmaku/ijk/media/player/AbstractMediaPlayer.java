...
public abstract class AbstractMediaPlayer implements IMediaPlayer {
    ...
    private OnScreenshotCompleteListener mOnScreenshotCompleteListener;
    ...
    public final void setOnScreenshotCompleteListener(OnScreenshotCompleteListener listener) {
        mOnScreenshotCompleteListener = listener;
    }
    ...
    public void resetListeners() {
        ...
        mOnScreenshotCompleteListener = null;
    ...
    protected final void notifyOnScreenshotComplete(int ret, String path) {
        ...
        if (mOnScreenshotCompleteListener != null)
            mOnScreenshotCompleteListener.onScreenshotComplete(this, ret, path);
    }
    ...
    protected final boolean notifyOnInfo(int what, int extra, Object obj) {
