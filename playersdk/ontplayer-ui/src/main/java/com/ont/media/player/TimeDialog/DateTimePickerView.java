...
public class DateTimePickerView extends PickerViewGroup {
    ...
    public static final int TYPE_YEAR_MONTH_DAY_HOUR = 3;

    protected int type = TYPE_YEAR_MONTH_DAY_HOUR;
    ...
    public DateTimePickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        type = typedArray.getInt(R.styleable.DateTimePickerView_type, TYPE_YEAR_MONTH_DAY_HOUR);
    ...
    private void configurePickerViews() {
        ...
        }, yearPickerView, monthPickerView, dayPickerView, hourPickerView);
        ...
        public String getText() {
            ...
            switch (field) {
                ...
                case FIELD_DAY:
                    ...
                    break;
                case FIELD_HOUR:
                    text = String.format(Locale.getDefault(), "%02d时", value);
                    break;
            }
            return text;
        }
