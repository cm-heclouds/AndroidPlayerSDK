...
public class PickerViewGroup extends LinearLayout {
    ...
    protected int preferredMaxOffsetItemCount = PickerView.DEFAULT_MAX_OFFSET_ITEM_COUNT;
    ...
    public PickerViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        preferredMaxOffsetItemCount = typedArray.getInt(R.styleable.PickerViewGroup_preferredMaxOffsetItemCount, PickerView.DEFAULT_MAX_OFFSET_ITEM_COUNT);
