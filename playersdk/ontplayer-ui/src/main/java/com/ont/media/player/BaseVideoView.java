...
public abstract class BaseVideoView extends FrameLayout implements IVideoView, OnPlayerEventListener {
    ...
    protected void initPlayer() {
        if (mMediaPlayer == null) {
            if (mPlayerConfig.mAbstractPlayer != null) {
                ...
                mMediaPlayer = new OntPlayer(getContext());
            }
    ...
    protected boolean isInPlayOrPauseState() {
        return (mMediaPlayer != null &&
